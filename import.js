...
function checkWin(game) {
    ...
    if (game.winners.length + inactivePlayers.length === game.players.length - 1) {
        ...
        //////////////////////////////////
        const winners = game.winners.map(winner => game.players[winner].playerName).join(',')
        const sql = `INSERT INTO winners (gameId, winners, turn, lastmovetime) VALUES (${game.gameId}, '${winners}', ${game.turn}, '${game.lastMoveTime.toISOString()}')`;
            ...
            pool.getConnection((err, connection) => {
                ...
                connection.query(sql, (queryErr, results) => {
                    ...
                    if (queryErr) {
                        console.error('Error inserting winners into MySQL database:', queryErr);
                    } else {
                        console.log('Winners inserted into MySQL database successfully');
                    }
                });
            });/////////////////////////////////////////////////////////////////
    }
